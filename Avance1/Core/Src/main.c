  ...
  while (1)
  {
	...
	case MT: //Medir temp
		...
		if (temperature < 0){
			...
			//primer y segundo led verde, primer amarillo
			HAL_GPIO_WritePin(LED_1V_GPIO_Port, LED_1V_Pin, 1);
			HAL_GPIO_WritePin(LED_2V_GPIO_Port, LED_2V_Pin, 1);
			...
			//primer y segundo led verde, primer amarillo y de segundo
			HAL_GPIO_WritePin(LED_1V_GPIO_Port, LED_1V_Pin, 1);
			HAL_GPIO_WritePin(LED_2V_GPIO_Port, LED_2V_Pin, 1);
			HAL_GPIO_WritePin(LED_1A_GPIO_Port, LED_1A_Pin, 1);
			...
			//primer y segundo led verde, primer amarillo y de segundo, primer rojo
			HAL_GPIO_WritePin(LED_1V_GPIO_Port, LED_1V_Pin, 1);
			HAL_GPIO_WritePin(LED_2V_GPIO_Port, LED_2V_Pin, 1);
			HAL_GPIO_WritePin(LED_1A_GPIO_Port, LED_1A_Pin, 1);
			HAL_GPIO_WritePin(LED_2A_GPIO_Port, LED_2A_Pin, 1);
